...
public final class Quaternion extends Quaternionf {
    ...
    public String toString() {
        ...
        stringbuilder.append("net.cloud.betterfog.forge.Quaternion[").append(this.r()).append(" + ");
    ...
    public Quaternionf mul(float p_80142_) {
        this.i *= p_80142_;
        this.j *= p_80142_;
        this.k *= p_80142_;
        this.r *= p_80142_;
        return mul(p_80142_, this);
    }
    ...
    public Quaternionf set(float p_80144_, float p_80145_, float p_80146_, float p_80147_) {
        this.i = p_80144_;
        this.j = p_80145_;
        this.k = p_80146_;
        this.r = p_80147_;
