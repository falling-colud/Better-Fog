...
public class BiomeColor {
    ...
    public static List<Double> getColor(Level level, BlockPos pos) {
        v = BetterFogConfiguration.BIOME_CHECK_VERTICAL_FACTOR.get();
        r = BetterFogConfiguration.BIOME_CHECK_RADIUS.get();
        checks = BetterFogConfiguration.BIOME_CHECKS_FOR_SIDE.get();
    ...
    public static List<Double> getBiomeFeatures(Level level, BlockPos pos) {
        ...
        for (String category_color : BetterFogConfiguration.BIOME_FEATURES_LIST.get()) {
